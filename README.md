...
#### 系统主要功能为C/S架构，数据服务使用Remoting通信(可发布并兼容WbeAPI)，消息使用Socket及WebSocket通信。<br>
#### 其中数据维护模块使用B/S架构，采用MVC模式开发，支持响应式布局（可在PC、平板、手机上浏览及操作）。<br>
#### 综合显示屏端使用安卓原生应用内嵌B/S方式开发，可动态更新及样式维护。<br><br>
#### Bin - 生成的程序集<br>
