...
{
    public class SCase2Controller : BaseController
    {
        BEvaluateBLL bll;
        TUnitBLL unitBll;
        TUserBLL userBll;

        public SCase2Controller()
        {
        ...
        {
            return Content(JsonConvert.SerializeObject(this.bll.GetWorkPercent(type, startTime, endTime, unitSeq, userId)));
        }
    }
}
